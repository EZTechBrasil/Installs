...
NcFTP\NcFTPPut -f EZServerCE.cfg -d logs\Upgrade5.log -m \NDFlash\Carrefour    \EZServerCE\INI\Carrefour\*.ini
copy \EZServerCE\INI\Carrefour\EZMonitor.ini \EZForecourt\EZMonitor
\EZForecourt\EZIPConfig

EZTelnet\EZTelnet -C StartCF.cmd -O logs\Upgrade.log 
:exit_install
echo All done. 
exit 
