...
NcFTP\NcFTPPut -f EZServerCE.cfg -d logs\install1.log -m \NDFlash\HTTP\Admin   \EZServerCE\HTTP\Admin\*.*
NcFTP\NcFTPPut -f EZServerCE.cfg -d logs\install2.log -m \NDFlash\HTTP\Main    \EZServerCE\HTTP\Main\*.*
NcFTP\NcFTPPut -f EZServerCE.cfg -d logs\install2.log -m \NDFlash\Log          \EZServerCE\logs\*.ini
