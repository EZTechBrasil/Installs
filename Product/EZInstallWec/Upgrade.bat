...
NcFTP\NcFTPPut -f Vision.cfg -d logs\install2.log -m \NDFlash\Log          \Vision\log\*.ini
...
NcFTP\NcFTPPut -f Vision.cfg -d logs\Upgrade4.log \NDFlash\EZForecourt  \Vision\INI\*.ini
