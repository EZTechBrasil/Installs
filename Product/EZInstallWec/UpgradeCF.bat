...
NcFTP\NcFTPPut -f Vision.cfg -d logs\Upgrade5.log -m \NDFlash\Carrefour    \Vision\INI\Carrefour\*.ini
copy \Vision\INI\Carrefour\EZMonitor.ini \EZForecourt\EZMonitor
\EZForecourt\EZIPConfig

EZTelnet\EZTelnet -C StartCF.cmd -O logs\StartCF.log 
:exit_upgrade
echo All done. 
pause
exit 
